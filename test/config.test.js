...
describe('config', () => {
  ...
  describe('format', () => {
    ...
    it('custom_params', () => {
      ;[
        [{}, undefined, 'return undefined by default'],
        [{ custom_params: {} }, undefined, 'return undefined on empty custom_params'],
        [{ custom_params: { a: 1, b: 2 } }, { a: 1, b: 2 }, 'return custom_params']
      ].forEach(([provider, result, message]) => {
    ...
    it('overrides', () => {
      ;[
        [{}, undefined, 'return undefined by default'],
        [{ overrides: {} }, undefined, 'return undefined on empty overrides'],
        [{ overrides: { a: { scope: 1 } } }, { a: { scope: 1 } }, 'return overrides'],
        [
  ...
  describe('defaults', () => {
    it('prefix', () => {
      ;[
        [{}, { prefix: '/connect' }],
        [{ prefix: '/oauth' }, { prefix: '/oauth' }],
        [{ path: '/api' }, { prefix: '/api/connect' }],
        [{ path: '/api', prefix: '/oauth' }, { prefix: '/api/oauth' }]
      ].forEach(([provider, result, message]) => {
